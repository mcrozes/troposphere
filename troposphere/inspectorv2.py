...
class ScopeConfiguration(AWSProperty):
    """
    `ScopeConfiguration <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-connector-scopeconfiguration.html>`__
    """
...
class AzureScopeConfigurationMap(AWSProperty):
    """
    `AzureScopeConfigurationMap <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-connector-azurescopeconfigurationmap.html>`__
    """

    props: PropsDictType = {
        "ContainerImageScanning": (ScopeConfiguration, False),
        "ServerlessScanning": (ScopeConfiguration, False),
        "VmScanning": (ScopeConfiguration, False),
    }


class AzureProviderConfiguration(AWSProperty):
    """
    `AzureProviderConfiguration <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-connector-azureproviderconfiguration.html>`__
    """

    props: PropsDictType = {
        "AutoInstallVMScanner": (boolean, False),
        "AwsConfigConnectorArn": (str, True),
        "AzureRegions": ([str], True),
        "ScopeConfiguration": (AzureScopeConfigurationMap, True),
    }


class ProviderConfiguration(AWSProperty):
    """
    `ProviderConfiguration <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-connector-providerconfiguration.html>`__
    """

    props: PropsDictType = {
        "Azure": (AzureProviderConfiguration, True),
    }


class Connector(AWSObject):
    """
    `Connector <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-inspectorv2-connector.html>`__
    """

    resource_type = "AWS::InspectorV2::Connector"

    props: PropsDictType = {
        "Description": (str, False),
        "Name": (str, True),
        "Provider": (str, True),
        "ProviderConfiguration": (ProviderConfiguration, True),
        "Tags": (Tags, False),
    }
...
class ConnectorHealth(AWSProperty):
    """
    `ConnectorHealth <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-connector-connectorhealth.html>`__
    """

    props: PropsDictType = {
        "ConnectorStatus": (str, False),
        "LastCheckedAt": (str, False),
        "Message": (str, False),
    }
