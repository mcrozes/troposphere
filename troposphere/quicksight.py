...
class ActionConnector(AWSObject):
    ...
    props: PropsDictType = {
        ...
        "AuthenticationConfig": (AuthConfig, True),
...
class Capabilities(AWSProperty):
    ...
    props: PropsDictType = {
        "AccessAppsNativeDataStore": (str, False),
        "Action": (str, False),
        ...
        "InvokeAppsAIInference": (str, False),
